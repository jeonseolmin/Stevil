...
(async () => {
  ...
  try {
    ...
    await planner.locator('.planner-day-select').first().click();
    ...
    console.log('PASS: optional snack recommendation, add between meals, count nutrients only after choice, completion and mocked save/reload, mobile layout');
