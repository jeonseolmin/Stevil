...
from retrieval.hybrid import DIMENSIONS, HybridSearch, VectorIndex, normalize
...
class HybridTests(unittest.TestCase):
    ...
    def test_cache_reuse_and_content_change(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch('retrieval.hybrid.embed', return_value=vector()) as api:
    ...
    def test_cosine_ranking(self):
        docs = [{'id': 'a', 'section': 'a', 'text': 'one'},
                {'id': 'b', 'section': 'b', 'text': 'two'}]
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch('retrieval.hybrid.embed', return_value=vector(1)):
