...
import PartnershipInquiryTab from "./PartnershipInquiryTab.jsx";
...
export default function AdminInquiriesPage() {
    ...
    return (
        <section className="admin-inquiries-page">
            ...
            <div className="admin-inquiries-tabs">
                <button
                    type="button"
                    className={
                        activeTab ===
                        "GENERAL"
                            ? "admin-inquiries-tab admin-inquiries-tab--active"
                            : "admin-inquiries-tab"
                    }
                    onClick={() =>
                        handleTabChange(
                        ...
                        {selectedInquiry && (
                            ...
                            >
                                <section className="admin-inquiry-modal">
                                    ...
                                    <footer className="admin-inquiry-modal-footer">
                                        <button
                                            type="button"
                                            className="secondary"
                                            onClick={
