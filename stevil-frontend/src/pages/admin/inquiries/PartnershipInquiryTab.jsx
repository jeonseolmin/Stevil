...
export default function PartnershipInquiryTab() {
    ...
    const handleOpenDetail = async (
        ...
        try {
            ...
            const response =
                await axiosInstance.get(
                    `/admin/partnership-inquiries/${inquiryId}`
                );
    ...
    return (
        <>
            <div className="admin-inquiries-sub-heading">
                <div>
                    <h2>제휴 문의</h2>
            ...
            {errorMessage && (
                <div className="admin-inquiries-error">
                    <span>
                        {errorMessage}
                    </span>
                ...
                >
                    <section className="admin-inquiry-modal">
                        ...
                        {selectedInquiry.status !==
                            "APPROVED" && (
                                <>
                                    <div className="admin-partnership-status-actions">
                                        {selectedInquiry.status ===
                                            "PENDING" && (
                                                <button
                                                    type="button"
                                    ...
                                    <div className="admin-partnership-reject">
                                        <label htmlFor="partnershipRejectReason">
                                            거절 사유
                                        </label>

                                        <textarea
                                            id="partnershipRejectReason"
                                            maxLength={
                                                500
                                            }
                                            value={
