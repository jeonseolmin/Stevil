...
export default function Dashboard({ previewData = null }) {
    ...
    const [topBanners, setTopBanners] =
        useState([]);

    const [sponsorAds, setSponsorAds] =
        useState([]);
    ...
    useEffect(() => {
        ...
        const fetchAds = async () => {
            try {
                ...
                const dashboardAdsResponse =
                    await axiosInstance.get(
                        "/ads/dashboard-ads"
                    );

                const adsMap =
                    dashboardAdsResponse.data ??
                    {};
                    ...
                    <div className="dashboard-popup-overlay">
                        <div className="dashboard-popup-content">
                            ...
                            <div className="popup-actions">
                                ...
                                <button
                                    type="button"
                                    className="btn-close-today"
                                    onClick={
                                        handleClosePopupToday
                                    }
                                >
                                    오늘 하루
                                    보지 않기
